...
|             **[A.1.1]** **LR_REF (Without Skewness and Outlier Treatment)**: Cross-Validation AUROC = 0.87475, Test AUROC = 0.88447 
|             **[A.1.2]** **LR_BCT (With Box-Cox Transformation)**: Cross-Validation AUROC = 0.88878, Test AUROC = 0.89676
|             **[A.1.3]** **LR_YJT (With Yeo-Johnson Transformation)**: Cross-Validation AUROC = 0.88070, Test AUROC = 0.89061 
|             **[A.1.4]** **LR_ET (With Exponential Transformation)**: Cross-Validation AUROC = 0.88053, Test AUROC = 0.89013
|             **[A.1.5]** **LR_IHST (With Inverse Hyperbolic Sine Transformation)**: Cross-Validation AUROC = 0.87107, Test AUROC = 0.87998 
|             **[A.1.6]** **LR_LOG10T (With Base-10 Logarithm Transformation)**: Cross-Validation AUROC = 0.89192, Test AUROC = 0.89882 
|             **[A.1.7]** **LR_LNT (With Natural Logarithm Transformation)**: Cross-Validation AUROC = 0.89192, Test AUROC = 0.89882 8 
|             **[A.1.8]** **LR_SRT (With Square Root Transformation)**: Cross-Validation AUROC = 0.88441, Test AUROC = 0.89461 
|             **[A.1.9]** **LR_WT (With Outlier Winsorization Treatment)**: Cross-Validation AUROC = 0.87428, Test AUROC = 0.88916
|             **[A.1.10]** **LR_SST (With Outlier Spatial Sign Treatment)**: Cross-Validation AUROC = 0.86608, Test AUROC = 0.88786
|
|
...
|
| ![](D:/Github_Codes/ProjectPortfolio/Portfolio_Project_20/docs/Project20_Summary.png)
|
# **3. References**
|
